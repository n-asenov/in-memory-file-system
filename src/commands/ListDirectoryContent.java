...
public class ListDirectoryContent implements Command {
  ...
  private static final Comparator<File> SIZE_DESCENDING =
      (f1, f2) -> Integer.compare(f2.getSize(), f1.getSize());
  ...
  private String getCurrentDirectoryContent(Comparator<File> fileComparator)
    ...
    List<String> currentDirectoryContent =
        fileSystem.getDirectoryContent(currentDirectoryPath, fileComparator);
