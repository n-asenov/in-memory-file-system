...
public class Pipe implements Command {
  ...
  private String executeCommands(List<String> arguments)
      throws InvalidArgumentException, FileAlreadyExistsException, FileNotFoundException,
          NotEnoughMemoryException {
  ...
  private void addLastCommandResultToCurrentCommand(
      List<String> currentCommand, String lastCommandResult) {
