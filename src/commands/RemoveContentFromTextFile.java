...
public class RemoveContentFromTextFile implements Command {
  ...
  public String execute(List<String> arguments, Set<String> options)
    ...
    String textFileAbsolutePath =
        currentDirectory.getAbsolutePath(arguments.get(textFilePathIndex));

    fileSystem.removeContentFromTextFile(
        textFileAbsolutePath, parsedInterval[START_INDEX], parsedInterval[END_INDEX]);
    return "";
  }
  ...
  private void validateArguments(List<String> arguments) throws InvalidArgumentException {
    ...
    if (arguments.size() != expectedArgumentsSize) {
      throw new InvalidArgumentException(
          "Command should receive " + expectedArgumentsSize + " arguments");
    }
  }
