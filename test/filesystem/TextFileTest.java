...
public class TextFileTest {
  ...
  @Test(expected = InvalidArgumentException.class)
  public void
      removeContentFromLines_RemoveContentFromNegativeLineNumber_ThrowInvalidArgumentException()
          throws InvalidArgumentException {
    int start = -1;
    int end = 2;
  ...
  @Test
  public void removeContentFromLines_RemoveContentFromAllLines_EmptyTextFile()
      throws InvalidArgumentException {
    int start = 1;
    int end = 5;
